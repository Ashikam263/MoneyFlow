...
const Dashboard = () => {
  ...
  const [randomPercentage1, setRandomPercentage1] = useState('');
  const [randomPercentage2, setRandomPercentage2] = useState('');
  ...
  useEffect(() => {
    ...
    if (storedData) {
      ...
      setRandomPercentage1(getRandomPercentage);
      setRandomPercentage2(getRandomPercentage);
    }
  }, []);
  ...
  const getRandomPercentage1 = () => {
    return Math.floor(Math.random() * 100) + 1;
  };
  const getRandomPercentage2 = () => {
    return Math.floor(Math.random() * 100) + 1;
  };
  ...
  return (
    <div className="flex flex-col justify-center items-center">
     ...
     <div className="flex justify-between gap-4 text-center mt-2 text-2xl font-mono">
      ...
      <Pricing total={total} incomeTotal={incomeTotal} expenseTotal={expenseTotal} />
